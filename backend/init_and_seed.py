            ...
            for i in range(min(len(tmpl), 4)):
                ...
                session.add(
                    WorkHourRecord(
                        ...
                        user_id=users[min(i + 2, len(users) - 1)].id,
                        weekly_hours=t["weekly_hours"],
                        weekend_policy=t["weekend_policy"],
                        overtime_compensation=t["overtime_compensation"],
                        shift_policy=t["shift_policy"],
        ...
        for idx, company in enumerate(created_companies):
            if company.certification_status in ["certified", "pending", "rejected"]:
                cert = Certification(
                    ...
                    else company.certification_status,
